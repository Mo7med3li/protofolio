...
const projects = [
  ...
  {
    title: "Fitness App - Gym Management System",
    description:
      "Collaborated in an Agile team to build a fitness app with React.js. Implemented secure authentication user roles. Developed type-safe forms with React Hook Form/Zod. Built a multi-language UI using React-intl and Shadcn/UI.",
    technologies: [
      "React",
      "React Router DOM",
      "Context API",
    ...
    demoLink:
      "https://fitness-cbagmhpxk-mohamed-alis-projects-f1c626db.vercel.app/",
  },
  {
